      ...
      <div className="db-hero" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
        <div className="db-hero-card db-hero-tint-blue">
          ...
          <div className="db-hero-info">
            <span className="db-hero-number">{totalMyTasks}</span>
            <span className="db-hero-label">My Tasks</span>
          </div>
        </div>
        <div className="db-hero-card db-hero-tint-amber">
          <div className="db-hero-icon db-icon-amber"><FiClock /></div>
          <div className="db-hero-info">
            <span className="db-hero-number">{inProgress}</span>
            <span className="db-hero-label">In Progress</span>
          </div>
        </div>
        <div className="db-hero-card db-hero-tint-green">
          ...
          <span className="db-hero-trend db-trend-up"><FiTrendingUp size={12} /> +{completedThisWeek}</span>
        </div>
        ...
        <div className="db-left-col">
          <div className="db-panel">
            <div className="db-panel-header">
              <h3 className="db-panel-title"><FiFileText className="db-panel-title-icon" /> My Tasks</h3>
            </div>
